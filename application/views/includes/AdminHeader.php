...
@media only screen and (min-device-width:998px) and (max-device-width: 1350px){
  ...
  <script>
    ...
    function loadPage(url){
      // alert('dcscs');
        // window.location =  '<?php //echo get_instance()->config->base_url().'index.php/StockManagementController'; ?>'+url;
        // alert('<?php //echo get_instance()->config->base_url(); ?>');
    }
  </script>
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="<?php echo get_instance()->config->site_url().'StockManagementController'; ?>" onclick="loadPage('StockManagementController');"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Stock Management</span></a></li>
